...
<div class="page-header">
    ...
    <?php if ($rol === 'Admin'): ?>
        <div class="acciones">
            <a href="../../public/index.php?action=contrato_editar&id=<?= $contrato['id'] ?>"
               class="btn btn-warning">
                <i class="fa-solid fa-pen"></i> Editar
            </a>
            <a href="../../public/index.php?action=contrato_eliminar&id=<?= $contrato['id'] ?>"
...
<div class="detail-grid">
    ...
    <div class="detail-card">
        <div class="card-header">
            <i class="fa-solid fa-house"></i> Propiedad
        </div>
        <div class="card-body">
            <div class="field-row">
                <span class="field-label">Dirección</span>
                <span class="field-value"><?= htmlspecialchars($contrato['propiedad_direccion'] ?? '') ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="detail-card">
        <div class="card-header">
            <i class="fa-solid fa-person"></i> Inquilino
        </div>
        <div class="card-body">
            <div class="field-row">
                <span class="field-label">Nombre</span>
                <span class="field-value"><?= htmlspecialchars($contrato['inquilino_nombre'] ?? $contrato['nombre_inquilino'] ?? '') ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="detail-card">
        <div class="card-header">
            <i class="fa-solid fa-file-contract"></i> Datos del contrato
        </div>
        <div class="card-body">
            <div class="field-row">
            ...
            <div class="field-row">
                ...
                <span class="field-value"><?= isset($contrato['fecha_inicio']) ? date('d/m/Y', strtotime($contrato['fecha_inicio'])) : '' ?></span>
            </div>
            <div class="field-row">
                <span class="field-label">Fecha fin</span>
                <span class="field-value"><?= isset($contrato['fecha_fin']) ? date('d/m/Y', strtotime($contrato['fecha_fin'])) : '' ?></span>
            </div>
            <div class="field-row">
                <span class="field-label">Monto mensual</span>
                <span class="field-value">$<?= number_format($contrato['monto_mensual'] ?? 0, 2) ?></span>
            </div>
            <div class="field-row">
                <span class="field-label">Registrado</span>
                <span class="field-value"><?= isset($contrato['created_at']) ? date('d/m/Y', strtotime($contrato['created_at'])) : '' ?></span>
            </div>
        </div>
    </div>
    ...
    <div class="detail-card">
        ...
        <div class="card-body">
            <?php if (!empty($contrato['observaciones'])): ?>
                <p class="observaciones-text"><?= htmlspecialchars($contrato['observaciones']) ?></p>
            <?php else: ?>
                <p style="color:#9ca3af; font-size:0.875rem;">Sin observaciones registradas.</p>
            <?php endif; ?>
        </div>
    </div>
    ...
    <div class="detail-card full">
        <div class="card-header">
            ...
            <?php if ($rol === 'Admin'): ?>
                <a href="../../public/index.php?action=pago_crear&contrato_id=<?= $contrato['id'] ?>"
                   style="margin-left:auto; font-size:0.8rem; color:#4da6ff; text-decoration:none; font-weight:500;">
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?= $p['fecha_pago'] ? date('d/m/Y', strtotime($p['fecha_pago'])) : '<span style="color:#9ca3af">—</span>' ?>
                        </td>
                        <td>
                        ...
                        <td>
                            <a href="../../public/index.php?action=pago_editar&id=<?= $p['id'] ?>"
                               class="btn btn-warning" style="padding:0.3rem 0.7rem; font-size:0.78rem;">
                                <i class="fa-solid fa-pen"></i>
                            </a>
                            <a href="../../public/index.php?action=pago_eliminar&id=<?= $p['id'] ?>"
                               class="btn btn-danger" style="padding:0.3rem 0.7rem; font-size:0.78rem;"
