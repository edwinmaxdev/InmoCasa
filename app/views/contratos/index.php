...
<style>
    ...
    .alerta-vencer-list li { margin: 2px 0; }
...
<div class="page-header">
    ...
    <?php if ($rol === 'Admin'): ?>
        <a href="../../public/index.php?action=contrato_crear" class="btn btn-primary">
...
<?php if (!empty($proximosAVencer)): ?>
    <div class="alerta-vencer">
        ...
        <div>
            <div class="alerta-vencer-title">
                <?= count($proximosAVencer) ?> contrato(s) próximo(s) a vencer en los próximos 30 días
            </div>
            <ul class="alerta-vencer-list">
                <?php foreach ($proximosAVencer as $c): ?>
                    <li>
                        <?= htmlspecialchars($c['propiedad_direccion']) ?> —
                        <?= htmlspecialchars($c['inquilino_nombre']) ?> —
                        vence en <strong><?= $c['dias_restantes'] ?> día(s)</strong>
                    </li>
                <?php endforeach; ?>
            </ul>
        </div>
                ...
                <tr>
                    ...
                    <td>
                        <div class="acciones">
                            ...
                            <?php if ($rol === 'Admin'): ?>
                                <a href="../../public/index.php?action=contrato_editar&id=<?= $c['id'] ?>"
                                   class="btn btn-sm btn-warning" title="Editar">
                                    <i class="fa-solid fa-pen"></i>
                                </a>
                                <a href="../../public/index.php?action=contrato_eliminar&id=<?= $c['id'] ?>"
