...
<div class="form-card">
    <form id="formInquilino" method="POST"
          action="http://localhost:8080/InmoCasa/public/index.php?action=inquilino_guardar"
          novalidate>
        <div class="form-grid">
            <div class="form-group full">
                <label>Nombre completo <span class="required">*</span></label>
                <input type="text" name="nombre" placeholder="Ej: Ana Suárez"
            ...
            <div class="form-group">
                ...
                <input type="text" name="telefono" placeholder="09XXXXXXXX"
            ...
            <div class="form-group full">
                ...
                <textarea name="referencia" placeholder="Referencia del inquilino..."><?= htmlspecialchars($_POST['referencia'] ?? '') ?></textarea>
            </div>
        </div>
