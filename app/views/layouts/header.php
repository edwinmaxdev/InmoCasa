...
<head>
    ...
    <link rel="stylesheet" href="<?= dirname(BASE_URL) ?>/css/style.css">
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <nav class="navbar">
        <a href="<?= BASE_URL ?>?action=dashboard" class="navbar-brand">
            Inmo<span>Casa</span>
        </a>
        ...
        <ul class="navbar-menu" id="navMenu">
            ...
            <?php if ($rol === 'Admin'): ?>
                ...
                <li>
                    <a href="<?= BASE_URL ?>?action=propietarios"
