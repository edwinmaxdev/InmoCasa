...
// Si viene contrato_id por GET (desde detalle de contrato)
$contrato_id_preseleccionado = $_GET['contrato_id'] ?? '';
?>
        ...
        <div class="form-grid">
            ...
            <div class="form-group full">
                ...
                <select name="contrato_id" id="contrato_id">
                    ...
                    <?php foreach ($contratos as $c): ?>
                        <option value="<?= $c['id'] ?>"
                            <?= ($c['id'] == ($contrato_id_preseleccionado ?: ($_POST['contrato_id'] ?? ''))) ? 'selected' : '' ?>>
                            #<?= $c['id'] ?> —
            ...
            <div class="form-group">
                ...
                <input type="text" name="mes_correspondiente" id="mes_correspondiente"
                       ...
                       value="<?= htmlspecialchars($_POST['mes_correspondiente'] ?? '') ?>">
            ...
            <div class="form-group">
                ...
                <select name="estado" id="estado" onchange="toggleFechaPago()">
                    <?php foreach (['Pendiente', 'Pagado', 'Vencido'] as $est): ?>
                        <option value="<?= $est ?>"
                            <?= ($_POST['estado'] ?? 'Pendiente') === $est ? 'selected' : '' ?>>
                            <?= $est ?>
                        </option>
                    <?php endforeach; ?>
                </select>
            ...
            <!-- Fecha de pago -->
            <div class="form-group" id="grupo_fecha_pago">
            ...
            <div class="form-group full">
                ...
                <textarea name="observaciones" id="observaciones"
                          placeholder="Notas adicionales del pago..."><?= htmlspecialchars($_POST['observaciones'] ?? '') ?></textarea>
            </div>
