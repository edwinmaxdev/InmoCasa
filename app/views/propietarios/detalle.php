...
<div class="page-header">
    <div class="breadcrumb">
        ...
        <div class="page-title"><i class="fa-solid fa-user"></i> Propietario #<?= htmlspecialchars($propietario['id'] ?? '') ?></div>
    </div>
    <div class="acciones">
        <a href="<?= BASE_URL ?>?action=propietario_editar&id=<?= $propietario['id'] ?? '' ?>" class="btn btn-warning"><i class="fa-solid fa-pen"></i> Editar</a>
        <a href="<?= BASE_URL ?>?action=propietarios" class="btn btn-secondary"><i class="fa-solid fa-arrow-left"></i> Volver</a>
    </div>
</div>

<div class="detail-card">
    <div class="card-header"><i class="fa-solid fa-address-card"></i> Datos del propietario</div>
    <div class="card-body">
        <div class="field-row"><span class="field-label">Nombre completo</span><span class="field-value"><?= htmlspecialchars($propietario['nombre'] ?? '') ?></span></div>
