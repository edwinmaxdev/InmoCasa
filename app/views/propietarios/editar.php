...
<?php $errores = $_SESSION['errores'] ?? []; unset($_SESSION['errores']); $propietario = $propietario ?? []; ?>
    ...
    <form id="formPropietario" method="POST" action="<?= BASE_URL ?>?action=propietario_actualizar&id=<?= $propietario['id'] ?? '' ?>" novalidate>
        <div class="form-grid">
            <div class="form-group full">
                ...
                <input type="text" name="nombre" value="<?= htmlspecialchars($propietario['nombre'] ?? '') ?>">
                <span class="field-error" id="err_nombre"></span>
            </div>
            <div class="form-group">
                <label>Cédula <span class="required">*</span></label>
                <input type="text" name="cedula" value="<?= htmlspecialchars($propietario['cedula'] ?? '') ?>">
                <span class="field-error" id="err_cedula"></span>
            </div>
            <div class="form-group">
                <label>Teléfono</label>
                <input type="text" name="telefono" value="<?= htmlspecialchars($propietario['telefono'] ?? '') ?>">
            </div>
            <div class="form-group">
                <label>Email <span class="required">*</span></label>
                <input type="email" name="email" value="<?= htmlspecialchars($propietario['email'] ?? '') ?>">
                <span class="field-error" id="err_email"></span>
            </div>
            <div class="form-group">
                <label>Dirección</label>
                <input type="text" name="direccion" value="<?= htmlspecialchars($propietario['direccion'] ?? '') ?>">
            </div>
        </div>
