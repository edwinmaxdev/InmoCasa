...
<?php $errores = $_SESSION['errores'] ?? []; unset($_SESSION['errores']); $tipo = $tipo ?? []; ?>
...
<div class="page-header">
    ...
    <div class="page-title"><i class="fa-solid fa-pen"></i> Editar tipo #<?= $tipo['id'] ?? '' ?></div>
</div>
...
<div class="form-card">
    <form id="formTipo" method="POST" action="http://localhost:8080/InmoCasa/public/index.php?action=tipo_actualizar&id=<?= $tipo['id'] ?? '' ?>" novalidate>
        <div class="form-group">
            <label>Nombre <span class="required">*</span></label>
            <input type="text" name="nombre" value="<?= htmlspecialchars($tipo['nombre'] ?? '') ?>">
