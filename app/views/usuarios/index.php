...
<div class="page-header">
    ...
    <a href="<?= BASE_URL ?>?action=usuario_crear" class="btn btn-primary">
        ...
        <table id="tablaUsuarios">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="acciones">
                            <a href="<?= BASE_URL ?>?action=usuario_editar&id=<?= $u['id'] ?>"
                               class="btn btn-sm btn-warning" title="Editar">
                                <i class="fa-solid fa-pen"></i>
                            </a>
                            <?php if ($u['id'] != $_SESSION['usuario_id']): ?>
                                <a href="<?= BASE_URL ?>?action=usuario_eliminar&id=<?= $u['id'] ?>"
